...
if __name__ == '__main__':
	...
	if len(sys.argv) > 2:
        ...
        print "usage: %s directory [set ID's]" % sys.argv[0] 
        sys.exit(1)
	...
	if set_ids and pid not in set_ids:
	    print "Ignoring set " + dir
	    continue
        else:
            print "Processing set " + dir
